	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#about-section" class="nav-link"><span>Acerca de</span></a></li>
	          <li class="nav-item"><a href="#resume-section" class="nav-link"><span>Experiencia</span></a></li>
	          <li class="nav-item"><a href="#services-section" class="nav-link"><span>Servicios</span></a></li>
	          <li class="nav-item"><a href="#skills-section" class="nav-link"><span>Habilidades</span></a></li>
	          
	          
	          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Fotos</span></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(http://res.cloudinary.com/dqmck2ujs/image/upload/v1589189203/h1vmvuq365qyfp3xloys.png);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <p><a href="#" class="btn btn-primary py-3 px-4">Contáctame</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">Conóceme</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
	      ...
	      <div class="slider-item">
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(http://res.cloudinary.com/dqmck2ujs/image/upload/v1589189228/qrbsmuwkeeghpw6isk45.png);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          	
			            <h1 class="mb-4 mt-3">Soy <span>Programdor web</span>  de la Ciudad de México</h1>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(http://res.cloudinary.com/dqmck2ujs/image/upload/v1589296896/mysx8ubd2jviebmzyq73.png);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <h2 class="mb-4">Acerca de mi</h2>
		            <p>Cuando tu trabajo es tu pasión, todo fluye de manera natural.</p>
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Nombre:</span> <span>Miguel A. Mendoza</span></li>
		            	<li class="d-flex"><span>Fecha de Nacimiento:</span> <span>JDiciembre 09, 1981</span></li>
		            	<li class="d-flex"><span>Dirección:</span> <span>Huayatla, Magdalena Contreras, Ciudad de México, Méx.</span></li>
		            	<li class="d-flex"><span>Codigo Postal:</span> <span>10003</span></li>
		            	<li class="d-flex"><span>Email:</span> <span>sarkoceles@ciencias.unam.mx</span></li>
                        <li class="d-flex"><span>Telefono:</span> <span>+52-56-1687-4064</span></li>
                        <li class="d-flex"><span>Web:</span> <span>www.sarkoceles.mx</span></li>
		            </ul>
		          </div>
		        </div>
