...
function posiciones() {
    ...
    var resultadoFiltrado = recorrerEntreFechas(posicionesFull.positions, dateInicial, dateFinal);
    ...
    $.each(posicionesRutas, function (index, item) {
        ...
        addTablaInfo(item[0], item[item.length - 1], velMax, distancia, item);
        // addTableData(item);
        // item.index = index;
        // addMarkerposicion(item);
...
function addTablaInfo(inicial, final, velMax, distanciaRecorrida, recorrido) {
